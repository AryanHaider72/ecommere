...
import { ChevronRight, Eye, EyeOff, Link, Mail } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <div className="flex w-full flex-col h-screen p-4 items-center bg-gray-100">
        <h1 className="text-3xl font-bold mt-10">Login / SignUp </h1>
        ...
        <div className="flex flex-col md:flex-row w-full max-w-5xl h-auto md:h-[600px] bg-white rounded-xl overflow-hidden shadow-xl relative">
          ...
          {/* Right Section - Form */}
          <div className="flex flex-col mb-10 justify-center w-full md:w-1/2 px-8 lg:px-16 py-10 bg-white relative z-10 md:ml-auto">
